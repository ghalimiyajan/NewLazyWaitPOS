...
export default class PrintOptionsOrders extends Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.mainBackgroundColor, { flex: 1, flexDirection: 'row', paddingBottom: '2%', paddingTop: '2%' }]}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', }}>
                        ...
                        <View style={{ flex: 0.48, backgroundColor: '#ffff', borderRadius: 16, justifyContent: 'space-around', padding: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.PRINT_ORDER[lan]}</Text>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.SHOW_CUTOMER_PHONE_NUMBER[lan]}</Text>
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <Switch ios_backgroundColor={'#59C9BF'} trackColor={{ false: '#707070', true: '#707070' }} />
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.SHOW_SERVANT_NAME[lan]}</Text>
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <Switch ios_backgroundColor={'#59C9BF'} trackColor={{ false: '#707070', true: '#707070' }} />
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.SHOW_PICKUP_DATE[lan]}</Text>
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <Switch ios_backgroundColor={'#59C9BF'} trackColor={{ false: '#707070', true: '#707070' }} />
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.DUPLICATE_COPIES[lan]}</Text>
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <Switch ios_backgroundColor={'#59C9BF'} trackColor={{ false: '#707070', true: '#707070' }} />
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ flex: 1 }}>{Dictionary.CUT_BY_CATEGORY[lan]}</Text>
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <Switch ios_backgroundColor={'#59C9BF'} trackColor={{ false: '#707070', true: '#707070' }} />
                                </View>
                            </View>
                ...
                {/* **************************************************Rightside****************************************************** */}
                {/* <View style={{ flex: 2, backgroundColor: 'red', justifyContent: 'space-around', padding: 10 }} >
                    <View style={{ flex: 0.16, backgroundColor: 'pink', paddingVertical: 5, }}>
